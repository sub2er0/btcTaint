...
class Graph:
    ...
    def addNode(self, id, label, start="", end="", startopen=False, endopen=False, pid="", r="", g="", b="", spells=[], size=""):
        self._nodes[str(id)] = Node(self, id, label, start, end, pid, r, g, b, spells, startopen, endopen, size)
...
class Node:
    ...
    def __init__(self, graph, id, label, start="", end="", pid="", r="", g="", b="", spells=[], startopen=False, endopen=False, size=""):
        self.id = id
        self.label = label
        self.start = start
